...
class ArpObjectFactory<T:IArpObject> {
	...
	public var overwriteStrategy(default, null):OverwriteStrategy = OverwriteStrategy.Error;
	...
	public function new(nativeClass:Class<T>, forceDefault:Null<Bool> = null, overwriteStrategy:OverwriteStrategy = OverwriteStrategy.Error) {
